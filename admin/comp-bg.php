...
<div class="card" style="width: 100%;">
	<div class="card-body" style="background-color:#66CC99;height:250px;">
	</div>
    <div class="card-body">
    <h5 class="card-title">Color</h5>
    <p class="card-text">Enter the color code below and add your favourite color.</p>
...
<div class="col-md-6">
<div class="card" style="width: 100%;">
  <img class="card-img-top" src="image-admin/image.jpg" alt="Card image cap" height="242px">
  <div class="card-body">
    <h5 class="card-title">Image</h5>
    <p class="card-text">Click the 'Upload File' button and add your favourite picture!</p>
	<form action="" method="post">
	<div class="form-group">
	<input type="file" class="form-control" name="add-img" id="add-img"  required />
	</div>
	<div class="form-group">
	<button type="submit" class="btn btn-primary">Live Preview</button>
