...
<!-- Toggle button -->
<button id="sidebarCollapse" type="button" class="btn btn-dark" data-toggle="collapse" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"> <i class="fa fa-cog" style="font-size:20px"></i> </button>
<!--Your Content here! -->
<div class="container">
<br>
<div class="card">
  ...
  <div class="card-body">
    <h5 class="card-title">Create your navbar here</h5>
      ...
      <div class="col-sm">
        ...
        <form method = "POST">
          <div class="form-group">
            ...
            <input type="text" class="form-control" data-toggle="tooltip" data-placement="right" id="Text1" aria-describedby="emailHelp" placeholder="Enter the no. of items" name ="number">
			</div>
			<br/>
                <div class="form-group" align="right">
                <button class="btn btn-primary" type="submit" name = "num">Add</button>
          ...
          for($i=1;$i<=$number;$i++){
          print"<br><label for='exampleInputPassword1'>Item$i</label>";
          print"<input type='text' class='form-control' id='exampleInputPassword4' placeholder='Item Name$i' name = 'item$i'>";
          }
        }?>
          </div>  
        </form>
